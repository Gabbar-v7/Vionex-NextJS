export class AsyncUtils {
     ...
     */
    static async catchError<T>(promise: Promise<T>): Promise<[undefined, T] | [Error, undefined]> {
        return promise
            .then(data => {
     ...
     */
    static async catchTypedError<T, E extends Error>(
        promise: Promise<T>,
     ...
     */
    static async catchMultiErrors<T>(promises: Promise<T>[]): Promise<Error[]> {
